...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/sig/cliente", "/sig/produto").hasAnyRole("ADMIN", "BIB") //
				.antMatchers("/sig/cliente/{id}", "/sig/produto").hasRole("ADMIN") // somente login jose pode excluir
